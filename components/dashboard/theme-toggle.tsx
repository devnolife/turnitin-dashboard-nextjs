    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="rounded-2xl p-2 border-2 border-gray-100 dark:border-gray-700">
        <DropdownMenuItem
          ...
          className={`flex items-center gap-2 rounded-xl px-3 py-2 text-base cursor-pointer ${
            theme === "light" ? "bg-primary-lighter text-primary" : ""
          }`}
        >
        ...
        <DropdownMenuItem
          ...
          className={`flex items-center gap-2 rounded-xl px-3 py-2 text-base cursor-pointer ${
            theme === "dark" ? "bg-primary-lighter/20 text-primary-light" : ""
          }`}
        >
        ...
        <DropdownMenuItem
          ...
          className={`flex items-center gap-2 rounded-xl px-3 py-2 text-base cursor-pointer ${
            theme === "system" ? "bg-primary-lighter/20 text-primary" : ""
          }`}
        >
